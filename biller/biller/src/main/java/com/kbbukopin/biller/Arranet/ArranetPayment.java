...
public class ArranetPayment {
	private static String ARRANET_PRIVATE_KEY;
	...
	public static void main(String[] args) throws Exception
	{
		...
		String mti = "2800";
                ...
                ARRANET_PRIVATE_KEY = Constants.ARRANET_PRIVATE_KEY;
                ...
                String sendStr = mti + bitmap + arranet_trace_number + localTime + "07" + dev_arranet_partner_id + bit40 + bit48 + ArranetInquiry.getArranetKey();
		...
		*/
		...
		System.out.println(line);
                ...
                String decryptedData = EncryptionUtils.decryptData(arranetSessionKey, ARRANET_PRIVATE_KEY);
                 EncryptionUtils.encryptData(decryptedData, arranetTraceNumber);
