 ...
 * @author Fahmi Work
 */
public class ConverterISO_backup {
...
//        bit43 = "";
        bit47 = "07KBS0000";
        bit48 =  "2300000000000000000000000"; 
...
//        System.out.println("localTime : " + localTime);
        ...
        SimpleDateFormat datemmdd = new SimpleDateFormat("MMdd");
        String dateMMDD = datemmdd.format(Calendar.getInstance().getTime());
        bit13 = dateMMDD;
        System.out.println("localTime : " + dateMMDD);
        ...
        String sendStr = mti + bitmap + bit3 + bit7 + bit12 + bit13 + bit37 +  bit47 + bit48 ;
